...
def get_sum_rain(start_date, end_date):
    ...
    query_second = f'SELECT Max(r.MEASVALUE) FROM( SELECT * FROM MEASUREMENTHIST WHERE MEASTIMESTAMP BETWEEN \'{end}, 00:00:00.000\' AND \'{end}, 07:00:00.000\' and MEASID = 10 ORDER BY MEASTIMESTAMP ASC) as r'
    rain = 0
    try:
